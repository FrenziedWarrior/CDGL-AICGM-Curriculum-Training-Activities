...
# TASK 1 - Import libraries and set up the main window
from tkinter import *
...
# TASK 2 - Add a title label and display an image
...
# TASK 3 - Create a function to show a message box
...
msg_btn = Button(window, text='Click to React', bg='blue',
                 fg='white', command=show_message)
msg_btn.pack(pady=5)

# TASK 4 - Create a function to open a new window with photo details
...
# TASK 5 - Run the main window loop
window.mainloop()
