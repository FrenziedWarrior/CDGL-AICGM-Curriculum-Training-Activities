...
# -------------------------------------------------------
# TASK 1 - Import Tkinter and create the window
# -------------------------------------------------------
from tkinter import *
...
# -------------------------------------------------------
# TASK 2 - Add a title Label at the top using grid
# -------------------------------------------------------
title = Label(window, text='My Profile Card',
              fg='white', bg='purple', width=40)
title.grid(row=0, column=0, columnspan=2, padx=10, pady=10)

# -------------------------------------------------------
# TASK 3 - Add Name and Hobby Labels and Entry boxes
# -------------------------------------------------------
...
# -------------------------------------------------------
# TASK 4 - Add a Frame with an About Me Text box inside
# -------------------------------------------------------
...
about_text = Text(about_frame, fg='green',
                  bg='lightyellow', width=40, height=4)
about_text.pack()

# -------------------------------------------------------
# TASK 5 - Add a Submit Button and run the window
# -------------------------------------------------------
