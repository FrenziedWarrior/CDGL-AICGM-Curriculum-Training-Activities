...
# LESSON 3 - OPERATIONS ON A FILE 2
# ACTIVITY - NOTEBOOK MERGER

# Topics: with open() | split() | os.path.exists() | os.remove() | File Merge

import os

# TASK 1 -- Read with Auto-Close
print("=== Science Notes ===")
...
# TASK 2 -- Count Words in Each Line
print("=== Word Count ===")
